...
// enter these 2 incoming energy and outgoing energy points with equal probability and set the interpolation scheme to linear between the incoming points
    ...
    stream << std::setw(14) << std::right << enerStart*1000000 << std::setw(14) << std::right << 1 << '\n';
    stream << std::setw(14) << std::right << 1 << '\n';
    stream << std::setw(14) << std::right << 1 << std::setw(14) << std::right << 1 << '\n';
    stream << std::setw(14) << std::right << eOut1*1000000 << std::setw(14) << std::right << 1 << '\n';

    stream << std::setw(14) << std::right << enerEnd*1000000 << std::setw(14) << std::right << 1 << '\n';
    stream << std::setw(14) << std::right << 1 << '\n';
    stream << std::setw(14) << std::right << 1 << std::setw(14) << std::right << 1 << '\n';
    stream << std::setw(14) << std::right << eOut2*1000000 << std::setw(14) << std::right << 1 << '\n';
